...
const Register = () => {
    ...
    return (
        <section className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-12 px-4 sm:px-6 lg:px-8 flex flex-col justify-center">
            <ToastContainer 
                position="top-right"
                autoClose={3000}
            ...
            <div className="max-w-md w-full mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 sm:p-10">
                    ...
                    <form onSubmit={onRegisterSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-gray-500">Enter your official shop/business name</p>
                        </div>
                ...
                <div className="mt-8 text-center">
                    <p className="text-gray-500 text-sm">
                        Need help?{' '}
                        <a href="mailto:support@ims.com" className="text-blue-600 hover:text-blue-700 font-medium">
                            Contact Support
                        </a>
                    </p>
                </div>
